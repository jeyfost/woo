...
<body>
	...
	<div style="margin: 40px auto auto 40px; font-size: 24px;">
		...
		<form method="post" id="admSettingsForm">
			...
			<label for="admSettingsLogin">Новый логин:</label>
			<br />
			<input type="text" name="admSettingsLogin" id="admSettingsLogin" />
			<br /><br />
			<label for="admSettingsPassword">Новый пароль:</label>
			<br />
			<input type="password" name="admSettingsPassword" id="admSettingsPassword" />
			<br /><br />
			<div id="button">
