...
echo "<br /><label for='editWorkSelect'>Работа:</label><br /><select id='editWorkSelect' name='editWorkSelect' onchange='workSelect()'><option disabled selected>- Выберите работу -</option>";
